...
% Technical report for github.com/asynced24/financial-ai-risk-governance-framework
%
% Build:
...
\author{Aryan Singh\\
\small\href{https://github.com/asynced24/financial-ai-risk-governance-framework}%
{github.com/asynced24/financial-ai-risk-governance-framework}\ \ (\code{v1.0.0})}
...
\begin{quote}
\code{git clone https://github.com/asynced24/financial-ai-risk-governance-framework.git}\\
\code{cd financial-ai-risk-governance-framework \&\& git checkout v1.0.0}\\
